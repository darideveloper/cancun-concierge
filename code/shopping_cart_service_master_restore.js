...
const services_prices = {
  "CATAMARAN & REEF SNORKEL EXPEDITION": 145,
...
function get_service_info(date_selected, buy_form) {
  ...
  const service_date = `${date_selected}`
  let service_name = buy_form.parentNode.parentNode.parentNode.querySelector("h3").innerHTML.trim()
