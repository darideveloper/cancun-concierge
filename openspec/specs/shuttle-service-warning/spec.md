...
The system SHALL display a warning message on the `/rutva-deb-airport-transfers` page to inform users about the limited availability of the shuttle service.
...
- **WHEN** a user visits the `/rutva-deb-airport-transfers/index.html` page
...
The system SHALL reduce the font size of the hero H1 (`h1.small`) on the `/rutva-deb-airport-transfers` page by 20%.
